...
function EmailIcon() {
  return (
    ...
    >
      ...
      <path d="m4.4 7.2 7.6 5.4 7.6-5.4" />
    </svg>
  );
}
...
export function DemoSocials({ className }: { className: string }) {
  return (
